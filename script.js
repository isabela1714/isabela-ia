...
const caixaAlternativas = document.querySelector(".caixa-alternativas"); // Corrigido
const caixaResultados = document.querySelector(".caixa-resultados"); // Corrigido
...
function mostraPergunta() {
    ...
    // Mostrar alternativas atuais
    perguntaAtual.alternativas.forEach((alternativa, index) => {
        const btn = document.createElement('button');
        btn.textContent = alternativa;
        btn.addEventListener('click', () => {
            // Aqui você pode adicionar lógica para lidar com a escolha da alternativa
            console.log(`Alternativa escolhida: ${alternativa}`);
            proximaPergunta();
        });
...
function proximaPergunta() {
    ...
    if (atual < perguntas.length) {
        ...
        // Mostrar resultados ou mensagem de conclusão
        caixaResultados.textContent = 'Você concluiu o questionário!';
